            ...
            <div class="flex w-full">
                <div class="mt-2 w-full">
                    <div>
                        ...
                        <SecondaryButton :disabled="selectedWh==null" :selected="currentBlock=='stockIn'" class="mr-2">
                            Наличие
                        </SecondaryButton>
                        <SecondaryButton :disabled="selectedWh==null" :selected="currentBlock=='orders'">
                            Заказы
                        </SecondaryButton>
                    </div>
                </div>
