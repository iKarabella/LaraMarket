...
<template>
    <section>
        <header>
            <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">Изменить пароль</h2>

            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                Убедитесь, что в вашей учетной записи используется длинный пароль из случайных символов, чтобы обеспечить безопасность.
            </p>
        </header>
